function [Fzz,Gzz] = cal_Fzz_mothed_4(mod, gobs, nodex, nodez)
...
for jj = 1:num_points
    ...
    for j = 1:NOTEZ
        for i = 1:NX
            ...
            if is_level
                ...
                % Adjust angle to the range 0¨C2¦Ð
                ...
                % Compute difference of logarithmic terms
    ...
    for i = 1:NX        % Column loop (X direction)
        for j = 1:NZ    % Row loop (Z direction)
            % Combine contributions from four edges:
            %   Top edge:    H_edge(j, i)

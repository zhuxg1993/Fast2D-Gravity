function [Fz,Gz] = cal_Fz_mothed_2(mod, gobs, nodex, nodez)
        ...
        for i = 1:size(mod, 1)
            ...
            for edge = 1:4 % Loop over the four edges of a single grid cell
                ...
                if abs(dx) < dx_eps
                    ...
                    f_val = G * xi * c3 * scale_factor;
                    f = f + f_val;
                    continue; % Skip subsequent calculations after handling
                end
                ...
                if abs(dz) < dz_eps
                    ...
                    f_val = 2.0 * G * zi * delta_c * scale_factor;
                    f = f + f_val;
                    continue; % Skip subsequent calculations after handling
                end
